(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.autoscreen = {}));
})(this, (function (exports) { 'use strict';

    var _documentCurrentScript = typeof document !== 'undefined' ? document.currentScript : null;
    exports.AutoScreenEnum = void 0;
    ...
    })(exports.AutoScreenEnum || (exports.AutoScreenEnum = {}));
    ...
    ***************************************************************************** */
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 3:
                        ...
                        dirname = dirnameFn(fileURLToPath((typeof document === 'undefined' && typeof location === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : typeof document === 'undefined' ? location.href : (_documentCurrentScript && _documentCurrentScript.src || new URL('autoscreen.umd.js', document.baseURI).href))));
    ...
    // * 屏幕缩放适配（两边留白）
    var useAutoScale = function (options) { return createCalcRateFn(__assign(__assign({}, options), { mode: exports.AutoScreenEnum.FIT })); };
    // *  X轴撑满，Y轴滚动条
    var useScrollYScale = function (options) { return createCalcRateFn(__assign(__assign({}, options), { mode: exports.AutoScreenEnum.SCROLL_Y })); };
    // *  Y轴撑满，X轴滚动条
    var useScrollXScale = function (options) { return createCalcRateFn(__assign(__assign({}, options), { mode: exports.AutoScreenEnum.SCROLL_X })); };
    // * 变形内容，宽高铺满
    var useFullScale = function (options) { return createCalcRateFn(__assign(__assign({}, options), { mode: exports.AutoScreenEnum.FULL })); };
    // * 计算缩放比例函数
    function createCalcRateFn(options) {
        ...
        var calcRate = function () {
            ...
            if (el) {
                switch (mode) {
                    case exports.AutoScreenEnum.FIT:
                        {
                            // 当前屏幕宽高比
                        ...
                        break;
                    case exports.AutoScreenEnum.SCROLL_X:
                        scale = calcRateByHeight(width, height, baseProportion);
                        break;
                    case exports.AutoScreenEnum.SCROLL_Y:
                        scale = calcRateByWidth(width, height, baseProportion);
                        break;
                    case exports.AutoScreenEnum.FULL:
    ...
    exports.useAutoScreen = useAutoScreen;
    exports.useFullScale = useFullScale;
    exports.useScrollXScale = useScrollXScale;
    exports.useScrollYScale = useScrollYScale;
